...
function [phonemelevel, wordlevel] = categorize_errors2(activation, targetword, P, D)
...
if length(which_row(D.trainingphons, attemptedword)) > 0
    wordness = 1;
else wordness = 0;
end
...
if wordness == 1
    cat_attemptedword = P.protcats(which_row(D.testingphons, attemptedword));
