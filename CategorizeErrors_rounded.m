...
function T = CategorizeErrors_rounded(T, D, P)
...
%             end
            ...
            phonemelevel(i,1) = uncertainty; % binarizationfactor of output phoneme
        ...
        wordlevel(3) = wordness;        % is the attemptedword an existing word?; 1/0
        wordlevel(4) = legality;        % is the attemptedword a phonotactically (C-V order) legal word?
        wordlevel(5) = samecat;         % is the attemptedword in the same prototype category as the targetword?; 0/1
